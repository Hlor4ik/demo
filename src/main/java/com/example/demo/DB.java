...
public class DB {
    ...
    static {
        ...
        sellers.add(seller2);
        Manager manager1=new Manager(1,"Дмитрий","Хорошилов","khoroshilov.545@gmail.com",true);
        managers.add(manager1);
        Manager manager2=new Manager(2,"Михаил","Арбузов","michaelarb111@gmail.com",true);
